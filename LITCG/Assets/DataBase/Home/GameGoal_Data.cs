...
static class GameGoal_Data{
    ...
    //獎懲皆有
    public static string[] E_GameGoal = new string[8] {"1.Complete Task", "2.Complete Learn", "3.Increase Score", "4.Get more Crystal","5.Collect more Cards", "6.Get more Badges", "7.Maintain Points", "8.Less Mistakes" };
    public static string[] C_GameGoal = new string[8] { "1.完成所有任務", "2.完成所有學習關卡", "3.提高分數", "4.獲得更多水晶", "5.蒐集所有卡牌", "6.獲得所有獎章", "7.點數維持原樣", "8.失誤次數最少" };

    public static string[] E_Item = new string[7] { "Score", "Coin", "Crystal", "卡牌", "獎章", "點數", "失誤" };
