...
class BQuestion_Class{
    private int QuestionNum = 1;
    private string Question = "";
    private string Answer_r = ""; //正解 ABC
    private string Answer_r_Content = ""; //正解內容
    private string Answer_c = ""; //使用者的答案 ABC
    private string Answer_c_Content = ""; //使用者的答案內容
    private string FeedBack = ""; //給答案
    public BQuestion_Class(int _QuestionNum = 1, string _Question = "", string _Answer_r = "", string _Answer_r_Content = "", string _Answer_c = "", string _Answer_c_Content = "", string _FeedBack = "")
    {
